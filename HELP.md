...
* The original package name 'com.example.ai-prompt-webclient-demo' is invalid and this project uses 'com.example.ai_prompt_webclient_demo' instead.
...
* [Getting Started with Distributed Tracing](https://docs.spring.io/spring-boot/3.5.10-SNAPSHOT/reference/actuator/tracing.html)
* [Spring Web](https://docs.spring.io/spring-boot/3.5.10-SNAPSHOT/reference/web/servlet.html)
* [Spring Reactive Web](https://docs.spring.io/spring-boot/3.5.10-SNAPSHOT/reference/web/reactive.html)
